...
export const navbarStyles = {
  ...
  desktopMenu: "hidden lg:flex justify-self-start items-center bg-white/50 px-2 py-1 rounded-full border border-white/30 gap-1 shadow-[0_4px_15px_rgba(0,0,0,0.05)]",
  navLink: "nav-link text-text-main font-semibold text-[14px] px-3 py-2 rounded-3xl transition-all duration-300 no-underline hover:text-primary hover:bg-primary/10",
